...
public class Ricovero implements Serializable {
    ...
    public Ricovero(boolean chiusa, Paziente pazienteRicoverato, Date dataInizioRicovero, Date dataFineRicovero, int durataOssTerapia, int durataVentilazAssistita){
        this.chiusa = chiusa;
