...
import srcClass.Somministrazione;
...
public class patientController implements Serializable{
    ...
    public void initData(String nome, String cognome, Ricovero ricovero, int typeOfAccount, LoggedUser userAccount){
       /* nomePaziente.setText(nome);
        ...
        else if(userAccount.getAccountType() == -1){
            ...
            @Override public void run() {
                ...
                try {
                    ...
                    if (dis.readBoolean()) {
                        ...
                        //Dico al server se sono un utente loggato o meno
                        dos.writeInt(userAccount.getAccountType());
                        dos.flush();
    ...
    public void prescriviFarmaco(){
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/src/View/prescrFarmaco.fxml"));
    ...
    public void somministraFarmaco(){
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/src/View/somministrazione.fxml"));
    ...
    public void compileDischargeLetter(){
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/src/View/dischargeLetter.fxml"));
        try {
